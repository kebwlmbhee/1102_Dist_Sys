...
### Prometheus的 Server 用於取得和存儲時序數據至 TSDB，其整體是藉由 pull-based的設計，該設計不是由 
 
### Client將數據提供給 Server，而通常是使用 GET 獲取Target 位置，讓服務去取得相應的指標後進行採集並交由Server
...
[Prometheus - TSDB理論](https://liqiang.io/post/writing-a-time-series-database-from-scratch-040e5f23)

[Prometheus - TSDB(1)](https://iter01.com/13061.html)

[Prometheus - TSDB(2)](https://blog.csdn.net/weixin_43257196/article/details/121199732)

[Prometheus - TSDB(4)](https://www.gushiciku.cn/pl/gsAR/zh-tw)

[Prometheus - TSDB(5)](https://www.helloworld.net/p/1132048613)
